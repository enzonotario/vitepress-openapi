...
const defaultValues = {
  ...
  requestBody: {
    defaultView: 'contentType' as 'schema' | 'contentType' | 'autogenerated',
  },
  jsonViewer: {
    deep: Number.POSITIVE_INFINITY,
    renderer: 'vue-json-pretty' as 'vue-json-pretty' | 'shiki' | string,
  },
  schemaViewer: {
    deep: Number.POSITIVE_INFINITY,
  },
  ...
  response: {
    responseCodeSelector: 'tabs' as 'tabs' | 'select',
    maxTabs: 5,
    body: {
      defaultView: 'contentType' as 'schema' | 'contentType' | 'autogenerated',
    },
