...
export function useTheme(initialConfig: PartialUseThemeConfig = {}) {
  ...
  function setRequestBodyDefaultView(value: 'schema' | 'contentType' | 'autogenerated') {
    if (!themeConfig.requestBody) {
      themeConfig.requestBody = {}
    }
    if (!themeConfig.requestBody.defaultView) {
      themeConfig.requestBody.defaultView = ref(value)
    } else {
  ...
  function setShowBaseURL(value: boolean) {
    ...
    if (!themeConfig.path.showBaseURL) {
      themeConfig.path.showBaseURL = ref(value)
    } else {
  ...
  function setJsonViewerDeep(value: number) {
    if (!themeConfig.jsonViewer) {
      themeConfig.jsonViewer = {}
    }
    if (!themeConfig.jsonViewer.deep) {
      themeConfig.jsonViewer.deep = ref(value)
    } else {
  ...
  function setJsonViewerRenderer(value: 'vue-json-pretty' | 'shiki' | string) {
    ...
    if (!themeConfig.jsonViewer.renderer) {
      themeConfig.jsonViewer.renderer = ref(value)
    } else {
  ...
  function setSchemaViewerDeep(value: number) {
    if (!themeConfig.schemaViewer) {
      themeConfig.schemaViewer = {}
    }
    if (!themeConfig.schemaViewer.deep) {
      themeConfig.schemaViewer.deep = ref(value)
    } else {
  ...
  function setResponseCodeSelector(value: 'tabs' | 'select') {
    if (!themeConfig.response) {
      themeConfig.response = {}
    }
    if (!themeConfig.response.responseCodeSelector) {
      themeConfig.response.responseCodeSelector = ref(value)
    } else {
  ...
  function setResponseCodeMaxTabs(value: number) {
    ...
    if (!themeConfig.response.maxTabs) {
      themeConfig.response.maxTabs = ref(value)
    } else {
  ...
  function setResponseBodyDefaultView(value: 'schema' | 'contentType' | 'autogenerated') {
    ...
    if (!themeConfig.response.body) {
      themeConfig.response.body = {}
    }
    if (!themeConfig.response.body.defaultView) {
      themeConfig.response.body.defaultView = ref(value)
    } else {
  ...
  function setPlaygroundJsonEditorMode(value: PlaygroundJsonEditorMode) {
    if (!themeConfig.playground) {
      themeConfig.playground = {}
    }
    if (!themeConfig.playground.jsonEditor) {
      themeConfig.playground.jsonEditor = {}
    }
    if (!themeConfig.playground.jsonEditor.mode) {
      themeConfig.playground.jsonEditor.mode = ref(value)
    } else {
  ...
  function setPlaygroundJsonEditorMainMenuBar(value: boolean) {
    ...
    if (!themeConfig.playground.jsonEditor.mainMenuBar) {
      themeConfig.playground.jsonEditor.mainMenuBar = ref(value)
    } else {
  ...
  function setPlaygroundJsonEditorNavigationBar(value: boolean) {
    ...
    if (!themeConfig.playground.jsonEditor.navigationBar) {
      themeConfig.playground.jsonEditor.navigationBar = ref(value)
    } else {
  ...
  function setPlaygroundJsonEditorStatusBar(value: boolean) {
    ...
    if (!themeConfig.playground.jsonEditor.statusBar) {
      themeConfig.playground.jsonEditor.statusBar = ref(value)
    } else {
  ...
  function setSecurityDefaultScheme(value: string | null) {
    if (!themeConfig.security) {
      themeConfig.security = {}
    }
    if (!themeConfig.security.defaultScheme) {
      themeConfig.security.defaultScheme = ref(value)
    } else {
  ...
  function setOperationBadges(value: OperationBadges[]) {
    if (!themeConfig.operation) {
      themeConfig.operation = {}
    }
    if (!themeConfig.operation.badges) {
      themeConfig.operation.badges = ref(value)
    } else {
  ...
  function setOperationSlots(value: OperationSlot[]) {
    ...
    if (!themeConfig.operation.slots) {
      themeConfig.operation.slots = ref(value)
    } else {
  ...
  function setOperationHiddenSlots(value: OperationSlot[]) {
    ...
    if (!themeConfig.operation.hiddenSlots) {
      themeConfig.operation.hiddenSlots = ref(value)
    } else {
  ...
  function setOperationCols(value: number) {
    ...
    if (!themeConfig.operation.cols) {
      themeConfig.operation.cols = ref(value as 1 | 2)
    } else {
      themeConfig.operation.cols.value = value as 1 | 2
    }
  }
