...
describe('operationsLinkPlugin', () => {
  ...
  it('transforms operation links correctly', () => {
    ...
    expect(output).toContain(`<p><a href="/operations/getUsers" class="OAOperationLink group/oaOperationLink"><span class="OAOperationLink-badge OAMethodBadge--get">GET</span><span class="OAOperationLink-title">Get Users</span></a></p>
`)
  })
  ...
  it('uses operation summary when no link text is provided', () => {
    ...
    expect(output).toContain(`<p><a href="/operations/getUserPets" class="OAOperationLink group/oaOperationLink"><span class="OAOperationLink-badge OAMethodBadge--get">GET</span><span class="OAOperationLink-title">Get a list of pets for a user</span></a></p>`)
  })
  ...
  it('uses operationId when no link text or summary is provided', () => {
    ...
    expect(output).toContain(`<p><a href="/operations/getUser" class="OAOperationLink group/oaOperationLink"><span class="OAOperationLink-badge OAMethodBadge--get">GET</span><span class="OAOperationLink-title">GET /users/{id}</span></a></p>
`)
  })
  ...
  it('respects custom linkPrefix', () => {
    ...
    expect(output).toContain(`<p><a href="/api/getUsers" class="OAOperationLink group/oaOperationLink"><span class="OAOperationLink-badge OAMethodBadge--get">GET</span><span class="OAOperationLink-title">Get Users</span></a></p>
`)
  })
